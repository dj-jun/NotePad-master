...
<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/14.png"/>

### （二）添加笔记查询功能（根据标题查询）
#### 1.在list_options_menu.xml中添加item
    <item
        android:id="@+id/menu_search"
        android:icon="@drawable/search"
        android:title="搜索"
        android:alphabeticShortcut="b" />
#### 2.修改NoteList.java中的onOptionsItemSelected函数，在switch中添加搜索的case语句
...
<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/16.png"/>

## 附加功能
### （一）UI美化：将笔记本主题背景设置为白色
#### 运行结果截图如下
...
#### 3.在NotePadProvider.java的static中添加对其相应的处理
    sNotesProjectionMap.put(
        NotePad.Notes.COLUMN_NAME_BACK_COLOR,
        NotePad.Notes.COLUMN_NAME_BACK_COLOR);
    )
#### 4.在NotePadProvider.java的inert中添加对其相应的处理
    if (values.containsKey(NotePad.Notes.COLUMN_NAME_BACK_COLOR) == false) {
        values.put(NotePad.Notes.COLUMN_NAME_BACK_COLOR, NotePad.Notes.DEFAULT_COLOR);
    }
#### 5.创建MyCurcorAdapter.java
...
#### 6.修改NoteList中的PROJECTION,在PROJECTION中添加颜色项
...
#### 7.将所用的SimpleCursorAdapter适配器改为MyCurcorAdapter
    private static final String[] PROJECTION = new String[] {
            NotePad.Notes._ID, // 0
            NotePad.Notes.COLUMN_NAME_TITLE, // 1
            //扩展 显示时间 颜色
...
#### 9.在editor_options_menu.xml中添加选项
    <item android:id="@+id/menu_color"
        android:title="改变背景颜色"
        android:icon="@drawable/background"
        app:showAsAction="always"/>
#### 10.修改NoteEditor中的onOptionsItemSelected()函数
    case R.id.menu_color:
        changeColor();
        break;
#### 11.NoteEditor中添加函数changeColor()
...
#### 14.在AndroidManifest.xml增加activity
    <activity
...
<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/5.png"/>

<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/6.png"/>

<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/7.png"/>

<img width="200" src="https://github.com/dj-jun/NotePad-master/blob/master/pictures/13.png"/>

### （三）导出笔记
#### 1.在菜单文件editor_options_menu.xml中添加一个导出笔记的选项
    <item android:id="@+id/menu_output"
        android:title="@string/menu_output" />
#### 2.在NoteEditor中修改onOptionsItemSelected()函数
...
#### 5.创建OutputText的Acitvity，用来选择颜色
